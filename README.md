...
#### Using curl:
```bash
curl -L -O "https://github.com/dig1talGhost/archutil/releases/download/v0.0.2/archutil-v0.0.2-linux-amd64"
curl -L -O "https://github.com/dig1talGhost/archutil/releases/download/v0.0.2/sha512sum.txt"
```
...
```
archutil-v0.0.2-linux-amd64: OK
```
...
```bash
mv archutil-v0.0.2-linux-amd64 "$GOBIN/archutil"
